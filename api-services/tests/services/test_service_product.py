...
class TestProductServiceGetByCategory:
    ...
    def test_get_products_by_category_with_pagination(self, db: Session):
        ...
        first_page = product_service.get_products_by_category_id(db, category.id, skip=0, limit=5)
        second_page = product_service.get_products_by_category_id(db, category.id, skip=5, limit=5)
