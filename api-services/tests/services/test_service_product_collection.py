...
class TestProductCollectionServiceGetAll:
    ...
    def test_get_all_collections_with_pagination(self, db: Session):
        ...
        second_page = product_collection_service.get_all_collections(db, skip=5, limit=5)
...
class TestProductCollectionServiceUpdate:
    ...
    def test_update_collection_name(self, db: Session):
        ...
        collection = ProductCollectionFactory.create(db=db, name="Old Name", slug="old-name")
        
        collection_in = ProductCollectionUpdate(name="New Name")
        updated = product_collection_service.update_collection(db, "old-name", collection_in)
    ...
    def test_update_collection_slug(self, db: Session):
        ...
        collection = ProductCollectionFactory.create(db=db, name="Collection", slug="old-slug")
        
        collection_in = ProductCollectionUpdate(slug="new-slug")
        updated = product_collection_service.update_collection(db, "old-slug", collection_in)
    ...
    def test_update_collection_description(self, db: Session):
        ...
        collection = ProductCollectionFactory.create(db=db, slug="test")
        
        collection_in = ProductCollectionUpdate(description="New description")
        updated = product_collection_service.update_collection(db, "test", collection_in)
    ...
    def test_update_collection_not_found_raises_error(self, db: Session):
        ...
        with pytest.raises(ValueError, match="Collection with slug 'nonexistent' not found"):
            product_collection_service.update_collection(db, "nonexistent", collection_in)
    ...
    def test_update_collection_duplicate_name_raises_error(self, db: Session):
        ...
        collection = ProductCollectionFactory.create(db=db, name="My Name", slug="my-slug")
    ...
    def test_update_collection_same_slug_allowed(self, db: Session):
        ...
        collection = ProductCollectionFactory.create(db=db, name="Old", slug="my-slug")
        
        collection_in = ProductCollectionUpdate(name="New", slug="my-slug")
        updated = product_collection_service.update_collection(db, "my-slug", collection_in)
    ...
    def test_update_collection_same_name_allowed(self, db: Session):
        ...
        collection = ProductCollectionFactory.create(db=db, name="My Name", slug="old")
