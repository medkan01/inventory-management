...
class TestProductCollectionCRUDRead:
    ...
    def test_get_collection_by_name(self, db: Session):
        ...
        found_collection = crud_product_collection.get_by_name(db=db, name="Summer 2024")
    ...
    def test_get_collection_by_nonexistent_name_returns_none(self, db: Session):
        ...
        found_collection = crud_product_collection.get_by_name(db=db, name="NonExistent")
        
        assert found_collection is None
    
    def test_get_collection_by_slug(self, db: Session):
        """Test de récupération d'une collection par son slug."""
        collection = ProductCollectionFactory.create(db=db, name="Summer 2024", slug="summer-2024")
        
        found_collection = crud_product_collection.get_by_slug(db=db, slug="summer-2024")
    ...
    def test_get_collection_by_nonexistent_slug_returns_none(self, db: Session):
        ...
        found_collection = crud_product_collection.get_by_slug(db=db, slug="nonexistent")
    ...
    def test_get_multi_collections_with_pagination(self, db: Session):
        ...
        all_collections = ProductCollectionFactory.create_batch(db=db, count=10)
