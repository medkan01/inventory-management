...
class TestProductGetByCollection:
    ...
    def test_get_products_by_collection_slug(self, client: TestClient, db: Session):
        ...
        ProductFactory.create_batch(db=db, count=4, category=category, collection=collection)
...
class TestProductCreate:
    ...
    def test_create_product_with_nonexistent_category_fails(self, client: TestClient, db: Session):
...
class TestProductUpdate:
    ...
    def test_update_product_with_nonexistent_category_fails(self, client: TestClient, db: Session):
        """Test qu'une catégorie inexistante retourne une erreur."""
        from uuid import uuid4
