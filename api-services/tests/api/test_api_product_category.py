...
class TestProductCategoryCreate:
    ...
    def test_create_category_duplicate_slug_fails(self, client: TestClient, db: Session):
...
class TestProductCategoryUpdate:
    ...
    def test_update_category_duplicate_slug_fails(self, client: TestClient, db: Session):
        """Test qu'un slug dupliqué retourne une erreur."""
