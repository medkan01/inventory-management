...
class TestProductCollectionCreate:
    ...
    def test_create_collection_duplicate_slug_fails(self, client: TestClient, db: Session):
    ...
    def test_create_collection_invalid_data_fails(self, client: TestClient, db: Session):
...
class TestProductCollectionUpdate:
    ...
    def test_update_collection_success(self, client: TestClient, db: Session):
        ...
        response = client.put(f"/api/v1/collections/{collection.slug}", json=update_data)
    ...
    def test_update_collection_duplicate_slug_fails(self, client: TestClient, db: Session):
        """Test qu'un slug dupliqué retourne une erreur."""
