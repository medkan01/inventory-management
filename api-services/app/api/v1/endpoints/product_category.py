...
def get_categories(
    ...
    - **limit**: Nombre maximum d'éléments à retourner (défaut: DEFAULT_PRODUCT_CATEGORY_LIMIT, max: MAX_PRODUCT_CATEGORY_LIMIT)
    ...
    categories = product_category_service.get_all_categories(db=db, skip=skip, limit=limit)
    return categories
...
def create_category(
    ...
    """
    try:
        category = product_category_service.create_category(db=db, category_in=category_in)
        return category
