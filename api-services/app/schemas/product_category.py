...
class ProductCategoryBase(BaseModel):
    ...
    slug: str = Field(
        ...
        min_length=1,
        max_length=100,
        description="The slug for the product category.",
    )
    description: Optional[str] = Field(
        None, description="A brief description of the product category."
    )
...
class ProductCategoryResponse(ProductCategoryBase):
    ...
    created_at: datetime = Field(
        ..., description="The timestamp when the product category was created."
    )
    updated_at: datetime = Field(
        ..., description="The timestamp when the product category was last updated."
    )
