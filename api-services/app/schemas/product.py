...
class ProductBase(BaseModel):
    ...
    name: str = Field(
        ..., min_length=1, max_length=200, description="The name of the product."
    )
    slug: str = Field(
        ...,
        min_length=1,
    ...
    collection_id: Optional[UUID] = Field(
        None, description="The unique identifier of the product collection."
    )
...
class ProductUpdate(BaseModel):
    ...
    name: Optional[str] = Field(
        None, min_length=1, max_length=200, description="The name of the product."
    )
    ...
    category_id: Optional[UUID] = Field(
        None, description="The unique identifier of the product category."
    )
    collection_id: Optional[UUID] = Field(
        None, description="The unique identifier of the product collection."
    )
